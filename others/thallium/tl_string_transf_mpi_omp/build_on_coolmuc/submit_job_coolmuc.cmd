#!/bin/bash
#SBATCH -J tl_string_transf_mpi_omp
#SBATCH -o ./logs/tl_string_mpiomp_test_%J.out
#SBATCH -e ./logs/tl_string_mpiomp_test_%J.err
#SBATCH -D ./
#SBATCH --get-user-env
#SBATCH --clusters=cm2
...
echo "mpirun -n ${SLURM_NTASKS} ./tl_string_rdma_transf"
mpirun -n ${SLURM_NTASKS} ./tl_string_rdma_transf

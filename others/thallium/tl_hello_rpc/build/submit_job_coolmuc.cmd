#!/bin/bash
#SBATCH -J hello_rpc_thallium
#SBATCH -o ./logs/rpc_thallium_test_%J.out
#SBATCH -e ./logs/rpc_thallium_test_%J.err
#SBATCH -D ./
#SBATCH --get-user-env
...
mpirun -n 1 --host ${node_arr[1]} ./tl_client ${server_addr}

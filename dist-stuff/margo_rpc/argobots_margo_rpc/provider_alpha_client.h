...
/**
 * The alpha_client_t handle.
 *
 * This will be pointing to an object keeping track of registered RPC
 * identifiers for our microservice. An object of this type will be created
 * using alpha_client_init and destroyed using alpha_client_finalize.
 *
 */
...
/**
 * The alpha_provider_handle_t handle.
 *
 * This will be pointing to a provider handle for a provider of the
 * Alpha service. An object of this type will be created using
 * alpha_provider_handle_create function and destroyed using
 * alpha_provider_handle_release. This object will have an internal
 * reference count. alpha_provider_handle_ref_incr will be used to
 * manually increment this reference count.
 *
 */

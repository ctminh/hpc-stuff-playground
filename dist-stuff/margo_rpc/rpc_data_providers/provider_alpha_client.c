...
int alpha_client_init(margo_instance_id mid, alpha_client_t* client)
{
    ...
    // When initializing the client, margo_registered_name is used to
    // check whether the RPC has been defined already. If it has,
    // we use this function to retrieve its id. Otherwise, we use the
    // usual MARGO_REGISTER macro.
    hg_bool_t flag;
    hg_id_t id;
        ...
        int32_t* result)
{
    ...
    // Notice the use of margo_provider_forward in alpha_compute_sum,

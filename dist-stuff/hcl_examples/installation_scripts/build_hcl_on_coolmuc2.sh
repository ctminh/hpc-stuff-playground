...
rm -r CMakeCache.txt  CMakeFiles  cmake_install.cmake  CTestTestfile.cmake  hcl.pc  install_manifest.txt  Makefile  test
...
cmake -DCMAKE_INSTALL_PREFIX:PATH=/dss/dsshome1/lxc0D/ra56kop/hcl/install/hcl-tl-roce \
        -DHCL_ENABLE_THALLIUM_ROCE=true \
